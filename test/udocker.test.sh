...
cwltool --rm-tmpdir --user-space-docker-cmd=udocker ../workflow/createindex_singlevirus.cwl ../workflow/createindex_singlevirus.job.NC_007605.1.yaml
...
cwltool --rm-tmpdir --user-space-docker-cmd=udocker ../../workflow/VIRTUS.PE.singlevirus.cwl ../../workflow/VIRTUS.PE.singlevirus.job.yaml
cd ..

cwltool --rm-tmpdir --user-space-docker-cmd=udocker ../workflow/createindex_singlevirus.cwl ../workflow/createindex_singlevirus.job.NC_001806.2.yaml
...
cwltool --rm-tmpdir --user-space-docker-cmd=udocker ../../workflow/VIRTUS.SE.singlevirus.cwl ../../workflow/VIRTUS.SE.singlevirus.job.yaml
cd ..
